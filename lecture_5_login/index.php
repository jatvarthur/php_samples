...
/*
 * Проверяет, что была выполнена отправка форму регистрации
 */
...
/*
 * Извлекает данные пользователя из запроса и выполняет их вализацию.
 * Если в процессе валидации возникли ошибки, что заполняет массив ошибок $errors.
